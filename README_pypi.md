...
`uncertainties` computes a linear approximation of `a * a` without warning you. `uncertain` throws a **compile-time error**, forcing you to explicitly choose `square(a)`, which applies the *exact* mathematical formula:
